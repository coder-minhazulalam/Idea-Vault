          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
            {ideas.map((idea, index) => {
              ...
              return (
                ...
                >
                  <span className="inline-flex w-fit rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-[11px] font-medium uppercase tracking-wide text-blue-500 dark:border-blue-500/20 dark:bg-blue-500/10 dark:text-blue-400">
                  ...
                  <div className="mt-auto flex items-center justify-between gap-3">
                    <div className="flex min-w-0 items-center gap-3">
                      <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-blue-50 text-xs font-semibold text-blue-500 dark:bg-blue-500/10 dark:text-blue-400">
                        {initials}
                      </div>
          ...
          <div className="flex min-h-[250px] items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-white text-center dark:border-white/10 dark:bg-[#111113]">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-400">
                Go to an idea and leave a comment.
              </p>
            </div>
          </div>
        )}
